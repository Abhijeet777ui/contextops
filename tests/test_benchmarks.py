...
SNAPSHOTS = {
    "01_simple_redundancy.json": {
        # Phase 5: structure_penalty reduced (10.75 -> 2.15) due to low-token confidence scaling. Score 75 -> 83.
        "score": 83,
        "redundancy_penalty": 6.62,
        "structure_penalty": 2.15,
        "top_recommendation_issue": "Redundant context: 100% similarity \u2014 exact duplicate content"
    },
    "02_semantic_duplicates.json": {
        # Phase 5: structure_penalty reduced (5.29 -> 1.06). Score 86 -> 90.
        "score": 90,
        "redundancy_penalty": 0.0,
        "structure_penalty": 1.06,
        "top_recommendation_issue": "Retrieval dominance"
    },
    "03_rag_overload.json": {
        # Phase 5: structure_penalty reduced (17.04 -> 3.41). Score 75 -> 88.
        "score": 88,
        "redundancy_penalty": 2.09,
        "structure_penalty": 3.41,
        "top_recommendation_issue": "Retrieval dominance"
    },
    "04_agent_trace_noise.json": {
        # Phase 5: structure_penalty reduced (5.0 -> 1.0). Score 92 -> 96.
        "score": 96,
        "redundancy_penalty": 0.0,
    ...
    "05_structured_data_case.json": {
        # Phase 5: structure_penalty reduced (15.0 -> 3.0). Score 72 -> 84.
        "score": 84,
        "redundancy_penalty": 0.0,
    ...
    "07_instruction_conflict.json": {
        # Phase 5: structure_penalty reduced (7.16 -> 1.43). Score 90 -> 95.
        "score": 95,
        "redundancy_penalty": 0.0,
        "structure_penalty": 1.43,
        "top_recommendation_issue": "Retrieval dominance"
    }
}
